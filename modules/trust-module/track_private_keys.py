        ...
        for fname in fnames:  # --- Through the files
            ...
            if os.path.isfile(filename):  # --- File exists
                    ...
                    for line in f:  # --- iterate line by line
                        ...
                        if (key_found):  # --- If private key
                            if encr.search(line, re.IGNORECASE):  # --- Check if file is encrypted or not
                                print " File [%s] is Encrypted " %filename
                                ENC_found = True
                                break;
                            else:
                                continue
                ...
                if (key_found):  # --- Post assessing the file
                    if (ENC_found):
                        print (" Key-file [%s] is encrypted" %filename)
                        pass
                    else:
                        print ("[ALERT] Key-file [%s] is not encrypted" %filename)
                        pass
    ...
    for line in f:  # --- iterate line by line
        if hash_patt.search(line, re.IGNORECASE):  # ---
            ...
            if loc_patt.search(line, re.IGNORECASE):  # ---
                ...
                print "same key different locattion"
                # ------
                ...
                print " The new addition = ", newline
                # f.close()
...
def main(argv):
    ...
    scan_private_keys(path, repo_file)
